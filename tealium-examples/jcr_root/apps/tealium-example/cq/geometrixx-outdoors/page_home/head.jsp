...
%><head>
    ...
    <% if (GeoHelper.notEmpty(keywords)) { %><meta http-equiv="keywords" content="<%= xssAPI.encodeForHTMLAttr(keywords) %>" /><% } %>
    <% if (GeoHelper.notEmpty(description)) { %><meta http-equiv="description" content="<%= xssAPI.encodeForHTMLAttr(description) %>" /><% } %>
    <script>
